...
@implementation YLBPageContentView
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(YLBContentViewWillBeginDragging:)]) {
        [self.delegate YLBContentViewWillBeginDragging:self];
    }
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(YLBContentViewDidScroll:startIndex:endIndex:progress:)]) {
        [self.delegate YLBContentViewDidScroll:self startIndex:startIndex endIndex:endIndex progress:progress];
    }
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(YLBContenViewDidEndDecelerating:startIndex:endIndex:)]) {
        [self.delegate YLBContenViewDidEndDecelerating:self startIndex:startIndex endIndex:endIndex];
    }
}
